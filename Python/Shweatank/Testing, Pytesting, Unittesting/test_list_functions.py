...
def test_clone_a_list(original, copy):
    assert list_functions.clone_a_list(original) == copy
...
def test_number_of_occurrences_in_a_list(n, arraylist, occurrences):
    assert list_functions.number_of_occurrences_in_a_list(n, arraylist) == occurrences
...
def test_remove_empty_tuples_from_list(arraylist, output):
    assert list_functions.remove_empty_tuples_from_list(arraylist) == output
...
def test_remove_duplicates_from_list(arraylist, duplicates):
    assert list_functions.remove_duplicates_from_list(arraylist) == duplicates
