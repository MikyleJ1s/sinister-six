...
myconn = mysql.connector.connect(host="localhost", user="root", passwd=dbmspass)
cur = myconn.cursor()  
try: 
    cur.execute("create database tester")
...
try:
    ...
    myconn = mysql.connector.connect(host="localhost", user="root", passwd=dbmspass, database="tester")
    cur = myconn.cursor()    
    cur.execute("use policy_management_system")
    try: 
        ...
        cur.execute("insert into user_table(user_name, user_email, user_surname, user_age, user_password) values\
                        ...
                        ")
        myconn.commit()
        print("User table has just been created")  
    except: 
        print("User table has been created")      
        
    try:
        cur.execute("create table policy_table(\
        ...
        cur.execute("insert into policy_table(policy_name, amount_paid, policy_decription, date_acquired, user_identifier) values\
                        ...
                        ")
        myconn.commit()
        print("Policy table has just been created")

    except:
        print("Policy table has been created")
        
    try:
        cur.execute("create table payment_table(\
        ...
        cur.execute("insert into payment_table(payment_description, amount_paid, payment_date, policy_identifier, user_identifier) values\
                        ...
                        ")
        myconn.commit()
        print("Payment table has just been created")
        
    except:
        print("Payment table has been created")
